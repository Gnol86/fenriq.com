export const translations = {
    "fr-FR": {
        ...
        DELETE_ORGANIZATION_INSTRUCTIONS:
            "Saisissez le slug de l'organisation pour confirmer :",
    ...
    "en-US": {
        ...
        MEMBER_ADD_FORBIDDEN: "You do not have permission to add members.",
        MEMBER_REMOVE_FORBIDDEN:
        ...
        NOT_ORGANIZATION_ADMIN: "You must be an organization administrator.",
        ...
        ROLE_CREATE_FORBIDDEN: "You do not have permission to create roles.",
        ROLE_UPDATE_FORBIDDEN:
            "You do not have permission to update this role.",
        ROLE_DELETE_FORBIDDEN:
            "You do not have permission to delete this role.",
        ROLE_DELETE_PROTECTED: "This role is protected and cannot be deleted.",
        PERMISSION_DENIED: "Permission denied for this action.",
        ACCESS_CONTROL_RESOURCE_UNKNOWN: "Unknown access control resource.",
        ACCESS_CONTROL_ACTION_FORBIDDEN:
        ...
        TEAM_CREATE_FORBIDDEN: "You do not have permission to create teams.",
        TEAM_UPDATE_FORBIDDEN:
        ...
        TEAM_MEMBER_ALREADY_EXISTS: "This user is already a team member.",
        TEAM_MEMBER_ADD_FORBIDDEN:
        ...
        ADMIN_PASSWORD_REQUIRED: "A password is required for this operation.",
        ADMIN_PASSWORD_TOO_WEAK: "Password does not meet security policy.",
        ...
        CANNOT_IMPERSONATE_OWNER: "Cannot impersonate an organization owner.",
        ADMIN_OPERATION_INVALID_PAYLOAD: "Invalid payload for admin operation.",
        ADMIN_OPERATION_RATE_LIMITED:
    ...
    "nl-NL": {
        ...
        MEMBER_ALREADY_EXISTS: "Deze gebruiker is al lid van de organisatie.",
        MEMBER_ADD_FORBIDDEN:
        ...
        NOT_ORGANIZATION_MEMBER: "U bent geen lid van deze organisatie.",
        NOT_ORGANIZATION_ADMIN: "U moet beheerder van de organisatie zijn.",
        NOT_ORGANIZATION_OWNER: "Actie gereserveerd voor organisatie-eigenaar.",
        ...
        ACCESS_CONTROL_RESOURCE_UNKNOWN: "Onbekende toegangscontrolebron.",
        ACCESS_CONTROL_ACTION_FORBIDDEN: "Actie verboden door rechtenbeleid.",
        ...
        TEAM_MEMBER_ALREADY_EXISTS: "Deze gebruiker is al lid van het team.",
        TEAM_MEMBER_ADD_FORBIDDEN:
        ...
        CANNOT_IMPERSONATE_OWNER: "Kan een organisatie-eigenaar niet imiteren.",
        ADMIN_OPERATION_INVALID_PAYLOAD:
    ...
    "de-DE": {
        ...
        INVITATION_ALREADY_CANCELLED:
            "Diese Einladung wurde bereits storniert.",
        ...
        NOT_ORGANIZATION_MEMBER: "Sie sind kein Mitglied dieser Organisation.",
        NOT_ORGANIZATION_ADMIN: "Sie müssen Organisationsadministrator sein.",
        NOT_ORGANIZATION_OWNER: "Aktion für Organisationsinhaber reserviert.",
        ...
        TEAM_MEMBER_ALREADY_EXISTS: "Dieser Benutzer ist bereits Teammitglied.",
        TEAM_MEMBER_ADD_FORBIDDEN:
