...
import { ChecklistTemplateBuilder } from "./checklist-template-builder";

export async function ChecklistBuilderNewPage() {
...
export async function ChecklistBuilderEditPage({ templateId }) {
    const t = await getTranslations("project.charroi.builder");
    const { organization } = await requirePermission({
