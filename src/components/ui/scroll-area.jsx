        ...
        <>
            <div
                ...
                className={cn(
                    ...
                    onCard
                        ? "before:from-card before:bg-gradient-to-b before:to-transparent"
                        : "before:from-background before:bg-gradient-to-b before:to-transparent",
                    onCard
                        ? "after:from-card after:bg-gradient-to-t after:to-transparent"
            ...
            <div
                ...
                className={cn(
                    ...
                    onCard
                        ? "before:from-card before:bg-gradient-to-r before:to-transparent"
                        : "before:from-background before:bg-gradient-to-r before:to-transparent",
                    onCard
                        ? "after:from-card after:bg-gradient-to-l after:to-transparent"
